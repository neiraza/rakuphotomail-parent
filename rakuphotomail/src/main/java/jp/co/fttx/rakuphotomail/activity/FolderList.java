...
public class FolderList extends K9ListActivity {
    ...
    class FolderListHandler extends Handler {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    String dispString = mAdapter.mListener.formatHeader(FolderList.this,
                            getString(R.string.folder_list_title, mAccount.getDescription()),
        ...
        public void accountSizeChanged(final long oldSize, final long newSize) {
            runOnUiThread(new Runnable() {
                public void run() {
                    String toastText =
                            getString(R.string.account_size_changed, mAccount.getDescription(),
    ...
    public static Intent actionHandleAccountIntent(Context context, Account account,
                                                   String initialFolder, boolean fromShortcut) {
    ...
    private static void actionHandleAccount(Context context, Account account,
                                            String initialFolder) {
    ...
    public static Intent actionHandleNotification(Context context, Account account,
                                                  String initialFolder) {
    ...
    public void onNewIntent(Intent intent) {
        ...
        if (fromNotification && mAccount.goToUnreadMessageSearch()) {
            ...
            finish();
        } else if (initialFolder != null && !RakuPhotoMail.FOLDER_NONE.equals(initialFolder)) {
            onOpenFolder(initialFolder);
            finish();
        } else if (intent.getBooleanExtra(EXTRA_FROM_SHORTCUT, false) &&
                !RakuPhotoMail.FOLDER_NONE.equals(mAccount.getAutoExpandFolderName())) {
    ...
    private void initializeActivityView() {
        ...
        getListView().setTextFilterEnabled(
                mAdapter.getFilter() != null); // should never be false but better safe then sorry
    ...
    @Override public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_H: {
                Toast toast =
                        Toast.makeText(this, R.string.folder_list_help_key, Toast.LENGTH_LONG);
                toast.show();
                return true;
            }
    ...
    private void onClearFolder(Account account, String folderName) {
        ...
        try {
            if (account == null || folderName == null || !account.isAvailable(FolderList.this)) {
                Log.i(RakuPhotoMail.LOG_TAG, "not clear folder of unavailable account");
                return;
            }
            ...
            Log.e(RakuPhotoMail.LOG_TAG, "Exception while clearing folder", e);
        } finally {
            if (localFolder != null) {
                localFolder.close();
            }
    ...
    private void onOpenFolder(String folder) {
        Log.d(RakuPhotoMail.LOG_TAG, "めっせーじりすとあくしょんはんだろー");
    ...
    @Override public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo menuInfo) {
        ...
        if (RakuPhotoMail.ERROR_FOLDER_NAME.equals(folder.name)) {
    ...
    class FolderListAdapter extends BaseAdapter implements Filterable {
        ...
        private ActivityListener mListener = new ActivityListener() {
            ...
            public void listFoldersFailed(Account account, String message) {
                if (account.equals(mAccount)) {
                    ...
                    if (Config.LOGV) {
                        Log.v(RakuPhotoMail.LOG_TAG, "listFoldersFailed " + message);
                    }
                }
                ...
                if (account.equals(mAccount)) {
                    ...
                    for (Folder folder : folders) {
                        ...
                        try {
                            ...
                            Log.e(RakuPhotoMail.LOG_TAG, "Unable to get unreadMessageCount for " +
                                    mAccount.getDescription() + ":"
                                    + folder.getName());
                        }

                        if (holder == null) {
                            holder = new FolderInfoHolder(context, folder, mAccount,
                                    unreadMessageCount);
                        } else {
            ...
            private void refreshFolder(Account account, String folderName) {
                ...
                try {
                    if (account != null && folderName != null) {
                        ...
                        if (folderHolder != null) {
                            folderHolder
                                    .populate(context, localFolder, mAccount, unreadMessageCount);
                            mHandler.dataChanged();
                        }
                    }
                } catch (Exception e) {
                    Log.e(RakuPhotoMail.LOG_TAG, "Exception while populating folder", e);
                } finally {
                    if (localFolder != null) {
                        localFolder.close();
                    }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (position <= getCount()) {
                ...
                Log.e(RakuPhotoMail.LOG_TAG, "getView with illegal positon=" + position
        ...
        public View getItemView(int itemPosition, View convertView, ViewGroup parent) {
            ...
            if (holder == null) {
                ...
                holder.newMessageCount =
                        (TextView) view.findViewById(R.id.folder_unread_message_count);
            ...
            if (folder.unreadMessageCount != 0) {
                ...
                holder.newMessageCount.setOnClickListener(
                        new FolderClickListener(mAccount, folder.name, folder.displayName,
            ...
            if (RakuPhotoMail.messageListStars() && folder.flaggedMessageCount > 0) {
            ...
            if (RakuPhotoMail.useCompactLayouts() && holder.folderListItemLayout != null) {
                holder.folderListItemLayout.setMinimumHeight(0);
            }
            holder.activeIcons.setOnClickListener(new OnClickListener() {
                public void onClick(View v) {
                    Toast toast = Toast.makeText(getApplication(), getString(R.string.tap_hint),
                            Toast.LENGTH_SHORT);
                    toast.show();
                }
            }
            ...
            holder.folderStatus
                    .setTextSize(TypedValue.COMPLEX_UNIT_DIP, mFontSizes.getFolderStatus());
        ...
        public class FolderListFilter extends Filter {
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                ...
                mFilteredFolders =
                        Collections.unmodifiableList((ArrayList<FolderInfoHolder>) results.values);
    ...
    private class FolderClickListener implements OnClickListener {
        ...
        FolderClickListener(BaseAccount nAccount, String folderName, String displayName,
    ...
    private void openUnreadSearch(Context context, final Account account) {
        String description = getString(R.string.search_title, mAccount.getDescription(),

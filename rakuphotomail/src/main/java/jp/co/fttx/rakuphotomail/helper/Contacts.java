    ...
    public static Contacts getInstance(Context context) {
        if (sInstance == null) {
            ...
            if (sdkVersion <= Build.VERSION_CODES.DONUT) {
                className = "jp.co.fttx.rakuphotomail.helper.ContactsSdk3_4";
                 ...
                 */
                className = "jp.co.fttx.rakuphotomail.helper.ContactsSdk5p";
            } else {
                className = "jp.co.fttx.rakuphotomail.helper.ContactsSdk5";
            }
            ...
            try {
                ...
                Log.e(RakuPhotoMail.LOG_TAG, "Couldn't find class: " + className, e);
            } catch (InstantiationException e) {
                Log.e(RakuPhotoMail.LOG_TAG, "Couldn't instantiate class: " + className, e);
            } catch (IllegalAccessException e) {
                Log.e(RakuPhotoMail.LOG_TAG, "Couldn't access class: " + className, e);
            } catch (NoSuchMethodException e) {
                Log.e(RakuPhotoMail.LOG_TAG, "Couldn't find constructor of class: " + className, e);
            } catch (IllegalArgumentException e) {
                Log.e(RakuPhotoMail.LOG_TAG, "Wrong arguments for constructor of class: " + className, e);
            } catch (InvocationTargetException e) {
                Log.e(RakuPhotoMail.LOG_TAG, "Couldn't invoke constructor of class: " + className, e);
            }
        }

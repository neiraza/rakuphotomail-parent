...
public class MessageWebView extends WebView {
     ...
     * to call the method.
     */
    public static final Method mGetBlockNetworkLoads = RakuPhotoMail.getMethod(WebSettings.class, "setBlockNetworkLoads");
    ...
    public void blockNetworkData(final boolean shouldBlockNetworkData) {
        ...
        if (mGetBlockNetworkLoads != null) {
            try {
                ...
                Log.e(RakuPhotoMail.LOG_TAG, "Error on invoking WebSettings.setBlockNetworkLoads()", e);
            }
        }
    ...
    public void configure() {
        ...
        if (RakuPhotoMail.zoomControlsEnabled()) {
        ...
        if (
            ...
            &&  RakuPhotoMail.mobileOptimizedLayout()) {
            webSettings.setLayoutAlgorithm(WebSettings.LayoutAlgorithm.SINGLE_COLUMN);
        } else {
            webSettings.setLayoutAlgorithm(WebSettings.LayoutAlgorithm.NARROW_COLUMNS);
        }

        webSettings.setTextSize(RakuPhotoMail.getFontSizes().getMessageViewContent());
    ...
    public void emulateShiftHeld() {
        try {
            ...
            Log.e(RakuPhotoMail.LOG_TAG, "Exception in emulateShiftHeld()", e);
        }
    }
}

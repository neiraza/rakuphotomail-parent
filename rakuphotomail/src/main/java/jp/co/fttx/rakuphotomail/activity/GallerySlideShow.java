...
//        createMessageListThread.start();
    ...
    private void reloadMessage() {
        ...
        ArrayList<MessageInfo> list = new ArrayList<LocalStore.MessageInfo>();
        try {
    ...
    private void onMailCurrent() {
        ...
        if (currentIndex >= minIndex && currentIndex <= maxIndex) {
            ...
            Toast.makeText(GallerySlideShow.this, "メールが存在しません。", Toast.LENGTH_SHORT);
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        Toast.makeText(GallerySlideShow.this, "" + position, Toast.LENGTH_LONG).show();
        if (newMailFlg) {

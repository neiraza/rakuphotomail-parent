 ...
 * On 2010-11-07
 * Translated to English, Ported to use the same (inferior) API as the more standard "ColorPickerDialog" and imported into the UCOM namespace by Jesse Vincent
...
import jp.co.fttx.rakuphotomail.view.ColorPickerBox;

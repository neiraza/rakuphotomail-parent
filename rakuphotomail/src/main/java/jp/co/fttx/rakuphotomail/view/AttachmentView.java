...
import jp.co.fttx.rakuphotomail.helper.MediaScannerNotifier;
...
public class AttachmentView extends FrameLayout {
	...
	public boolean populateFromPart(Part inputPart, Message message, Account account,
		...
		try {
			...
			if ((!MimeUtility.mimeTypeMatches(contentType, RakuPhotoMail.ACCEPTABLE_ATTACHMENT_VIEW_TYPES))
					|| (MimeUtility.mimeTypeMatches(contentType,
							RakuPhotoMail.UNACCEPTABLE_ATTACHMENT_VIEW_TYPES))) {
				viewButton.setVisibility(View.GONE);
			}
			if ((!MimeUtility
					.mimeTypeMatches(contentType, RakuPhotoMail.ACCEPTABLE_ATTACHMENT_DOWNLOAD_TYPES))
					|| (MimeUtility.mimeTypeMatches(contentType,
							RakuPhotoMail.UNACCEPTABLE_ATTACHMENT_DOWNLOAD_TYPES))) {
				downloadButton.setVisibility(View.GONE);
			}
			if (size > RakuPhotoMail.MAX_ATTACHMENT_DOWNLOAD_SIZE) {
				viewButton.setVisibility(View.GONE);
				downloadButton.setVisibility(View.GONE);
			}
	...
	public void writeFile() {
		writeFile(new File(RakuPhotoMail.getAttachmentDefaultPath()));
	}
	...
	public void showFile() {
		...
		try {
			...
			Log.e(RakuPhotoMail.LOG_TAG, "Could not display attachment of type " + contentType, e);
			Toast toast = Toast.makeText(mContext,
					mContext.getString(R.string.message_view_no_viewer, contentType), Toast.LENGTH_LONG);
			toast.show();
		}
	}

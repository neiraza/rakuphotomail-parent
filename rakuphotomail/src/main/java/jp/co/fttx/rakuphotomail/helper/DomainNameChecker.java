...
public class DomainNameChecker {
    ...
    private static boolean isIpAddress(String domain) {
        ...
        try {
            ...
            if (RakuPhotoMail.DEBUG) {
                Log.v(RakuPhotoMail.LOG_TAG, "DomainNameChecker.isIpAddress(): "
                      + errorMessage);
            }
    ...
    private static boolean matchIpAddress(X509Certificate certificate, String thisDomain) {
        if (RakuPhotoMail.DEBUG) {
            Log.v(RakuPhotoMail.LOG_TAG, "DomainNameChecker.matchIpAddress(): this domain: " + thisDomain);
        }
                    ...
                    if ((altNameEntry != null) && (2 <= altNameEntry.size())) {
                        ...
                        if (altNameType != null) {
                            if (altNameType == ALT_IPA_NAME) {
                                ...
                                if (altName != null) {
                                    if (RakuPhotoMail.DEBUG) {
                                        Log.v(RakuPhotoMail.LOG_TAG, "alternative IP: " + altName);
                                    }
    ...
    private static boolean matchDns(X509Certificate certificate, String thisDomain) {
        ...
        try {
            ...
            if (RakuPhotoMail.DEBUG) {
                ...
                Log.v(RakuPhotoMail.LOG_TAG, "DomainNameChecker.matchDns(): "
                      + errorMessage);
            }
        }

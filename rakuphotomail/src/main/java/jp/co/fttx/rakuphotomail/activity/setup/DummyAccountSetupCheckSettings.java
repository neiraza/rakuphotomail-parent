 ...
 */
public class DummyAccountSetupCheckSettings extends RakuPhotoActivity implements OnClickListener {
    ...
    private void showErrorDialog(final int msgResId, final Object... args) {
        mHandler.post(new Runnable() {
            public void run() {
                ...
                new AlertDialog.Builder(DummyAccountSetupCheckSettings.this)
            ...
            public void run() {
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        DummyAccountSetupCheckSettings.actionCheckSettings(DummyAccountSetupCheckSettings.this, mAccount,

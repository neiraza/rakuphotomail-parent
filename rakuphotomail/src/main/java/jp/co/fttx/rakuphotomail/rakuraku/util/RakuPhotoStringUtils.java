...
public class RakuPhotoStringUtils {
	 ...
	 * @return String[]
	 */
	public static String[] splitConmma(String str) {
		return str.split(",");
	}
	 ...
	 */
	public static String[] splitMailAdressList(String mailAdress) {
		if (mailAdress != null) {
			String[] mailAddressList = splitConmma(mailAdress);
	...
	public static StringBuffer getMailAddress(String[] mailAddressList) {
		...
		for (String mailAddress : mailAddressList) {
			mailAddressInfo.append(RakuPhotoStringUtils
					.splitMailAddress(mailAddress));
	...
	public static StringBuffer getMailAddressInfoList(String mailAddressList) {
		...
		mailAddressInfo.deleteCharAt(mailAddressInfo.lastIndexOf(System
	...
	public static String[] splitFlags(String flag) {
		if (flag != null) {
			String[] flagList = splitConmma(flag);
			if (flagList != null) {
				return flagList;
			}
		}

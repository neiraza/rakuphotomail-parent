...
public class MimeBodyPart extends BodyPart {
    ...
    public void setBody(Body body) throws MessagingException {
        this.mBody = body;
        if (body instanceof jp.co.fttx.rakuphotomail.mail.Multipart) {
            jp.co.fttx.rakuphotomail.mail.Multipart multipart = ((jp.co.fttx.rakuphotomail.mail.Multipart)body);

...
import jp.co.fttx.rakuphotomail.mail.store.Pop3Store;
...
public abstract class Store {
     ...
     *
     * @throws MessagingException if not {@link StorageProvider#isReady(Context)}
     */
    public synchronized static LocalStore getLocalInstance(Account account, Application application)
            throws MessagingException {
        Log.v(RakuPhotoMail.LOG_TAG, "Store#getLocalInstance account:" + account.toString() +
    ...
    public abstract List<? extends Folder> getPersonalNamespaces(boolean forceListAll)
            throws MessagingException;

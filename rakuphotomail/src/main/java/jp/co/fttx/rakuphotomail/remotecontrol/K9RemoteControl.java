package jp.co.fttx.rakuphotomail.remotecontrol;
...
public class K9RemoteControl {
     ...
     */
    public final static String K9_REMOTE_CONTROL_PERMISSION = "jp.co.fttx.rakuphotomail.permission.REMOTE_CONTROL";
    /**
     ...
     */
    public final static String K9_REQUEST_ACCOUNTS = "jp.co.fttx.rakuphotomail.K9RemoteControl.requestAccounts";
    public final static String K9_ACCOUNT_UUIDS = "jp.co.fttx.rakuphotomail.K9RemoteControl.accountUuids";
    public final static String K9_ACCOUNT_DESCRIPTIONS = "jp.co.fttx.rakuphotomail.K9RemoteControl.accountDescriptions";

    /**
     * The {@link {@link Intent}} Action to set in order to cause K-9 to check mail.  (Not yet implemented)
     */
    //public final static String K9_CHECK_MAIL = "jp.co.fttx.rakuphotomail.K9RemoteControl.checkMail";

    /**
     * The {@link {@link Intent}} Action to set when remotely changing K-9 Mail settings
     */
    public final static String K9_SET = "jp.co.fttx.rakuphotomail.K9RemoteControl.set";
    /**
     ...
     * is absent or false.
     */
    public final static String K9_ACCOUNT_UUID = "jp.co.fttx.rakuphotomail.K9RemoteControl.accountUuid";
    /**
     ...
     */
    public final static String K9_ALL_ACCOUNTS = "jp.co.fttx.rakuphotomail.K9RemoteControl.allAccounts";
     ...
     */
    public final static String K9_NOTIFICATION_ENABLED = "jp.co.fttx.rakuphotomail.K9RemoteControl.notificationEnabled";
    /*
     * Key for the {@link Intent} Extra for controlling whether K-9 will sound the ringtone for new unread mail.
     * Acceptable values are K9_ENABLED and K9_DISABLED
     */
    public final static String K9_RING_ENABLED = "jp.co.fttx.rakuphotomail.K9RemoteControl.ringEnabled";
    /*
     * Key for the {@link Intent} Extra for controlling whether K-9 will activate the vibrator for new unread mail.
     * Acceptable values are K9_ENABLED and K9_DISABLED
     */
    public final static String K9_VIBRATE_ENABLED = "jp.co.fttx.rakuphotomail.K9RemoteControl.vibrateEnabled";
     ...
     */
    public final static String K9_PUSH_CLASSES = "jp.co.fttx.rakuphotomail.K9RemoteControl.pushClasses";
    /**
     * Key for the {@link Intent} Extra to set for controlling which folders to be synchronized with Poll.
     * Acceptable values are K9_FOLDERS_ALL, K9_FOLDERS_FIRST_CLASS, K9_FOLDERS_FIRST_AND_SECOND_CLASS,
     * K9_FOLDERS_NOT_SECOND_CLASS, K9_FOLDERS_NONE
     */
    public final static String K9_POLL_CLASSES = "jp.co.fttx.rakuphotomail.K9RemoteControl.pollClasses";
     ...
     */
    public final static String K9_POLL_FREQUENCY = "jp.co.fttx.rakuphotomail.K9RemoteControl.pollFrequency";
     ...
     */
    public final static String K9_BACKGROUND_OPERATIONS = "jp.co.fttx.rakuphotomail.K9RemoteControl.backgroundOperations";
     ...
     */
    public final static String K9_THEME = "jp.co.fttx.rakuphotomail.K9RemoteControl.theme";
